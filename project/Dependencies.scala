...
/**
  * Holds the list of dependencies used in the project and their various version It gives a central
  * place to quickly update dependencies
  */
object Dependencies {
